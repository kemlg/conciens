...
(defn process-line [txt]
    (def splitted_text (re-seq #"[^\|]+" txt))
      ...
      (= (nth splitted_text 0 "not-found") "WEATHER_UPDATE") ( println "WEATHER_UPDATE is not a relevant event")
      ...
      (= (nth splitted_text 0 "not-found") "OBJECT_UPDATE") ( println "OBJECT_UPDATE is not a relevant event")
      ...
      (= (nth splitted_text 0 "not-found") "CREATURE_UPDATE") ( println "CREATURE_UPDATE is not a relevant event")
